...
CREATE TABLE `task`  (
  ...
  `status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '任务状态 -1 结束 0 待运行  1 运行中 2 暂停',
...
INSERT INTO `task` VALUES ('1654348299', '间隔任务', 'interval', '', NULL, 5, 'def hello():  print(\'hello3\')', '间隔5秒执行', NULL, NULL, '0', NULL);
